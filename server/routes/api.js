...
router.get('/transactions', async (req, res) => {
    try {
        ...
        // Find all transactions where dateOfSale is stored as a string and convert to Date
        const transactionsWithStringDate = await Transaction.find({ dateOfSale: { $type: 'string' } });
        for (const doc of transactionsWithStringDate) {
